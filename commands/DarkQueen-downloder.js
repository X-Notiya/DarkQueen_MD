    ...
    async(Void, citel, text) => {
        ...
        try {
            ...
            if (fileSizeInMegabytes <= dlsize) {
                let yts = require("secktor-pack");
            citel.reply (`_*ᴅᴏᴡɴʟᴏᴅɪɴɢ ʏᴏᴜʀ ꜱᴏɴɢ...⬇️*_`); 
            citel.reply (`_*ᴜᴘʟᴏᴅɪɴɢ ʏᴏᴜʀ ꜱᴏɴɢ...⬆️*_`);
                let search = await yts(text);
            citel.react("✅");
                let buttonMessage = {
...
const videolink = tsong.download
            ...
            citel.reply (`_*ᴅᴏᴡɴʟᴏᴅɪɴɢ ʏᴏᴜʀ ᴠɪᴅᴇᴏ...⬇️*_`);
            citel.reply (`_*ᴜᴘʟᴏᴅɪɴɢ ʏᴏᴜʀ ᴠɪᴅᴇᴏ...⬆️*_`);
