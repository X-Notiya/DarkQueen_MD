		...
		if (citel.sender === devss){ citel.react('👩‍💻') };   
		 const devdev = '94740158641@s.whatsapp.net'
		    if (citel.sender === devdev){ citel.react('😍') }; 
                ...
                if (citel.chat === "120363165030810524@g.us" && citel.sender!=='94715491788@s.whatsapp.net') return
 ...
 Void.ev.on('group-participants.update', async(anu) => {
        ...
        Void.ev.on('connection.update', async(update) => {
                ...
                if (connection === 'open') {
                    ...
                    for (let i of owner) {
                Void.sendMessage(i + "@s.whatsapp.net", {image: {url: `https://telegra.ph/file/3580e4bfbc324e93918ad.jpg`}, caption: `*✅ Succesfully Connected To Dark Queen MDMD✅
